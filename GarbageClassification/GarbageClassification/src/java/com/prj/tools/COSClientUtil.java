...
public class COSClientUtil {
    private static final String domainName ="https://school-1256137468.cos.ap-guangzhou.myqcloud.com";
    //todo 这些变量信息自行到 腾讯云对象存储控制台 获取
    // 存储通名称            替换成自己的
    private static final String bucketName = "school-1256137468";
    //secretId          替换成自己的
    private static final String secretId = "AKIDvjNtCK7fdS8dx5DtX0INL8i8OTPBwCVd";
    // secretKey                替换成自己的
    private static final String secretKey = "4xe9RejlibZMxNkz61lPiuuiPvGj4EX5";
    ...
    public String uploadFile2Cos(MultipartFile file, String name) throws Exception {
        if (file.getSize() > 30 * 1024 * 1024) {
            throw new Exception("上传图片大小不能超过30M！");
        }
        try {
